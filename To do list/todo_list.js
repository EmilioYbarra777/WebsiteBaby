...
const generateTemplate = (todo, checked = false) => {
    ...
    // Debugging line to ensure checked state is applied
    console.log(`Generated todo with checked state: ${checked}`);
};
...
todoList.addEventListener('change', (e) => {
    if (e.target.type === 'checkbox') {
        saveTodos(); // Save todos to local storage when checkbox state changes
    }
});
